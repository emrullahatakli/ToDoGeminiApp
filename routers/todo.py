...
def create_todo_with_gemini(todo_string: str):
    ...
    full_prompt = (
        "I want you to act as a task manager. I will provide a short todo item, "
        "and you will rewrite it into a more comprehensive, actionable description. "
        "Do not engage in conversation, just return the enhanced description.\n\n"
        f"Todo Item: {todo_string}")
